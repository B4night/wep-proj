...
save_path = "resnet50_cifar100_model.pth"

preprocessor = AutoImageProcessor.from_pretrained("jialicheng/cifar100-resnet-50")
model = AutoModelForImageClassification.from_pretrained("jialicheng/cifar100-resnet-50")
# model.load_state_dict(torch.load(save_path, weights_only=True))  # Load the saved state_dict with weights_only=True
