...
# Function to test all models in the ./compressed_model/ folder
def test_all_models():
    # Get list of all model files in the ./compressed_model/ folder
    model_folder = "./compressed_model"
    model_files = [f for f in os.listdir(model_folder) if f.endswith(".pth")]
    
    if not model_files:
        print("No model files found in the ./compressed_model/ folder.")
        return
